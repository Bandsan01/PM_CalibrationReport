		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List View of Calendar for Calibration",
									"targetURL": "#comappzicaliclndr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappzicaliclndr-display": {
								"semanticObject": "comappzicaliclndr",
								"action": "display",
								"description": "List View of Calendar for Calibration",
								"title": "List View of Calendar for Calibration",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.zicaliclndr",
									"url": sap.ui.require.toUrl("com/app/zicaliclndr")
								}
							}
						}
					}
